            ...
            <Container>
                <Row>
                    <Col>
                        ...
                        <div className="flex flex-col md:flex-row gap-[20px] justify-between pb-8 mt:pb-16">
                            <div className="w-full flex flex-col gap-[15px] md:border-r border-primary-yellow footer-columns column-first">
                                ...
                                <p className="text-sm text-primary-yellow font-semibold">Contact Number : +919609600074</p>
                            </div>

                            <div className="w-full flex flex-col md:flex-row gap-[20px] footer-columns justify-between">
                        ...
                        <div className="flex flex-col items-center text-center gap-1.5 px-2.5 pt-6 pb-2.5">
                            ...
                            <p className="text-[12px]"><b>1.</b> The images shown are for illustration purposes only and may not be an exact representation of the product</p>
                            <p className='mt-1.5 text-[12px]'><b>2.</b> Please be advised that this website is not an official site and serves solely as an informational portal managed by a RERA authorized real estate agent. It does not constitute an offer or guarantee of any services. The prices displayed on this website are subject to change without prior notice, and the availability of properties cannot be guaranteed. The images showcased on this website are for representational purposes only and may not accurately reflect the actual properties. We may share your data with Real Estate Regulatory Authority (RERA) registered Developers for further processing as necessary. Additionally, we may send updates and information to the mobile number or email address registered with us.</p>
                            <p className="text-[12px]">All rights reserved. The content, design, and information on this website are protected by copyright and other intellectual property rights. Any unauthorized use or reproduction of the content may violate applicable laws. For accurate and up-to-date information regarding services, pricing, availability, and any other details, it is recommended to contact us directly through the provided contact information on this website. Thank you for visiting our website.</p>
                            <p className='mt-1.5 text-[12px]'><b>3.</b> We are the Authorized Channel Partner of 'Vamana Group'. All rights for logo & images are reserved to developer.</p>
                            <p className='mt-1.5 text-[12px]'><NavLink to='/terms-conditions' target='_blank' className='text-primary-yellow font-semibold'>Terms & Conditions</NavLink> and <NavLink to='/privacy-policy' target='_blank' className='text-primary-yellow font-semibold'>Privacy Policy</NavLink></p>
                            <p className='mt-1.5 text-[12px]'>Crafted By: <NavLink to='https://iosandweb.net/' target='_blank' className='hover:text-primary-yellow'>IosAndWeb Technologies</NavLink></p>
                        </div> 
                    </Col>
                </Row>
            </Container>
