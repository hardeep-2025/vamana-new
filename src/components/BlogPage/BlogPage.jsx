...
const BlogPage = () => {
    ...
    return(
        <>
            ...
            <div className="blog_page_section padding-top padding-bottom"  ref={blogRef}>
                <Container>
                    <Row>
                        <Col>
                                        ...
                                        {filterData && filterData.map((item, index) => 
                                            ...
                                            <Card key={item.id} className="blog_grid_card_item">
                                                <a key={index} href={"/blog/"+item.url}>
                                                    <Card.Img variant="top" src={item.image ? `${process.env.REACT_APP_API_URL}/admin/uploads/${item.image}` : defaultImage} />
                                                </a>
