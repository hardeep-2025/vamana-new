...
const Home = () => {
    return (
        <>
            <MetaData 
                title={"Vamana Arvindam Zirakpur - 3BHK, 3+1BHK & 4BHK Luxury Flats for Sale in Zirakpur"} 
                description={"Vamana Arvindam Zirakpur offering 3BHK & 4BHK luxury flats with modern amenities and prime connectivity. Discover premium residential flats for sale in the heart of Zirakpur."} 
